...
<section class="content">
  <div class="container-fluid">
    ...
    @endphp
       <form action="{{ route('admin.cfa.productstock') }}" method="get">
        ...
        <div class="row" style="text-align: left;">
          ...
          <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
            <select class="form-control" id="selectedBranch" name="selectedBranch" disabled>
              <option value="" <?php if($selectedBranch=="cancelled"){?> selected <?php } ?>> -- Select Branch -- </option>
              @foreach($branches as $keys)
              <option value="{{ $keys->id }}" <?php if($selectedBranch==$keys->id){?> selected <?php } ?>>{{ $keys->name }}</option>
              @endforeach
            </select>
          </div>
          ...
          <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6" style="color: black;">
                <div id="date-range">
    ...
    <form action="{{ route('admin.cfa.product_export_cfa') }}" method="get">
        <input type="hidden" name="category_id" id="export_cat" value="{{ $category_id }}">
        <input type="hidden" name="selectedBranch" id="selectedBranch_export" value="{{ $selectedBranch }}">
        ...
        z-index: 11;
        margin-left: 96px;
        margin-top: 20px;">Export with Details</button>
    </form>
    </div>
    <div class="row">
      <div class="col-12">
                  ...
                  <tbody>
                    ...
                    // echo '<pre>';
                      ...
                      foreach($products as $product){
                        ...
                        $proimage =\App\Models\ProductImage::where('product_id', $product->pro_id)->first();
                    ...
                    @endphp
                      <tr>
                        ...
                        <td><img src="{{ asset('storage/'.$proimage->image) }}" height="100px" width="150px"></td>
