  ...
  <div class="container-fluid">
    <div>
      ...
      @if(Auth::user()->branch_id=="")
       <form action="{{ route('admin.subscription.user.orders',['id'=>$get_user_sub_data->id]) }}" method="get">
      @endif
      {{-- @if(Auth::user()->branch_id!="")
       <form action="{{ route('admin.cfa.orders.index') }}" method="get">
      @endif --}}
        <div class="row" style="text-align: left;">
          ...
          @if(Request::is('admin/orders/index'))
            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
              <select class="form-control" id="selectedBranch" name="selectedBranch">
          ...
          @if(Request::is('admin/cfa/orders/index'))
           ...
           @endif
            ...
            <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5" style="color: black;">
                <div id="date-range">
            ...
            <table id="orders" class="table table-bordered">
              ...
              <tbody>
                ...
                @endphp
                  ...
                  @endif
                  @if(Auth::user()->branch_id!="")
                    <td><a href="{{ route('admin.cfa.orders.show',[ 'order' => $key->id]) }}" class="btn btn-success"><i class="fas fa-eye"></i></a></td>
                  @endif
                  </tr>
                @php
                    }
