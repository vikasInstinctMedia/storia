  ...
  <tbody>
    <tr>
      <td valign="top" style="padding:0cm 0cm 0cm 0cm">
        <p class="MsoNormal" align="center" style="text-align:center"><span style="font-size:12.0pt;font-family:&quot;Times New Roman&quot;,serif"><img src="https://shop.storiafoods.com/public/front/images/logo.png" alt="Storia Foods Online Store" class="CToWUd"><u></u><u></u></span></p>
        <div align="center">
            ...
            <tbody>
              <tr>
                <td valign="top" style="border:none;padding:0cm 0cm 0cm 0cm">
                  <div align="center">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100.0%;background:#0f914f">
                      <tbody>
                        <tr>
                              ...
                              <tbody>
                                <tr>
                                  <td valign="top" style="padding:36.0pt 36.0pt 24.0pt 36.0pt">
                                    ...
                                    <p class="MsoNormal" style="margin-bottom:13.5pt;line-height:130%"><b><span style="font-size:13.5pt;line-height:130%;font-family:&quot;Helvetica Neue&quot;;color:#0f914f">[Order #{{ $order->order_number }}]  ( {{ isset($order->created_at) ? $order->created_at->format('F d,Y') : date('F d,Y') }} )<u></u><u></u></span></b></p>
                                    <p class="MsoNormal" style="margin-bottom:13.5pt;line-height:130%"><b><span style="font-size:13.5pt;line-height:130%;font-family:&quot;Helvetica Neue&quot;;color:#0f914f">AWB Number :  {{ $order->awb_number }}  <u></u><u></u></span></b></p>
                                    <table border="1" cellspacing="0" cellpadding="0" width="100%" style="width:100.0%;border:solid #e5e5e5 1.0pt">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td style="border:solid #e5e5e5 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt">
                                            <p class="MsoNormal"><span style="font-size:12.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363">₹{{ $order->cart_details['shipping_charge'] }}&nbsp;</span><span style="font-size:10.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363">via Flat rate</span><span style="font-size:12.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363"> <u></u><u></u></span></p>
                                          </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2" style="border:solid #e5e5e5 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt">
                                              <p class="MsoNormal"><b><span style="font-size:12.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363">Cod Charges:<u></u><u></u></span></b></p>
                                            </td>
                                            <td style="border:solid #e5e5e5 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt">
                                              <p class="MsoNormal"><span style="font-size:12.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363">₹{{ $order->cart_details['cod_charge'] }}&nbsp;</span><span style="font-size:10.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363"></span><span style="font-size:12.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363"> <u></u><u></u></span></p>
                                            </td>
                                          </tr>
                                        ...
                                        <tr>
                                          <td width="50%" valign="top" style="width:50.0%;border:none;padding:0cm 0cm 0cm 0cm">
                                            <p class="MsoNormal" style="margin-bottom:13.5pt;line-height:130%"><b><span style="font-size:13.5pt;line-height:130%;font-family:&quot;Helvetica Neue&quot;;color:#0f914f">Billing address<u></u><u></u></span></b></p>
                                            <div style="border:solid #e5e5e5 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt">
                                              <p class="MsoNormal" style="border:none;padding:0cm"><i><span style="font-size:12.0pt;font-family:&quot;Helvetica Neue&quot;;color:#636363">{{ $order->customer_name }}<br> {{ $order->customer_address }} <br>{{ $order->shipping_city }} {{ $order->shipping_zip }} <br> <br><a href="tel:+919890044442" rel="noreferrer noreferrer" target="_blank"><span style="color:#0f914f">{{ $order->customer_phone }}</span></a> <br><a href="mailto:rohan.gandhi@sysweave.com" rel="noreferrer noreferrer" target="_blank"><span style="color:blue">{{ $order->customer_email }}</span></a> <u></u><u></u></span></i></p>
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
