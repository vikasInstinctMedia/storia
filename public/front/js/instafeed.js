 ...
 ! function(e, t) {
    ...
    function t(t) {
        ...
        var o = {
            ...
            success: null,
            target: "instafeed",
            template: '<div class="owl-item" style="width: 283px;"><div class="product-item text-center"><div id="" class="product-thumb"><a href="{{link}}" target="_blank"><img title="{{caption}}" src="{{image}}"/></a></div></div></div>',
            templateBoundaries: ["{{", "}}"],
            transform: null
        };
        if (t)
